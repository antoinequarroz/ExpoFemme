...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticatorTest extends \SwiftMailerTestCase
{
    ...
    public function testLMv1Generator()
    {
        ...
        $this->assertEquals($lmv1, bin2hex($lmv1Result), '%s: The keys should be the same 06.cause we use the same values to generate them.');
    }
    ...
    public function testLMv2Generator()
    {
        ...
        $this->assertEquals($lmv2, bin2hex($lmv2Result), '%s: The keys should be the same 06.cause we use the same values to generate them.');
    }
