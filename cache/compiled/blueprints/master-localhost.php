...
return [
    ...
    'timestamp' => 1611666835,
    'checksum' => 'c1554cdb4f6ade296815962719396152',
    'files' => [
        ...
        'user/themes' => [
            'themes/expoFemme' => [
                'file' => 'user/themes/expoFemme/blueprints.yaml',
                'modified' => 1610531697
            ],
            'themes/quark' => [
...
',
            ...
            'themes.expoFemme.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.expoFemme.dropdown',
                'form_field' => false
            ],
            'themes.expoFemme.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.expoFemme.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                'expoFemme' => [
                    'dropdown' => [
                        'enabled' => 'themes.expoFemme.dropdown.enabled'
                    ]
                ],
                'quark' => [
