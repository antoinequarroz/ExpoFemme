...
class __TwigTemplate_c175a7b207fbbd5aab43e6f9034ccf5eb45ecd6fc22084cac967bf8b4305c668 extends \Twig\Template
{
    ...
    public function block_group($context, array $blocks = [])
    {
        ...
        if ($this->getAttribute(($context["field"] ?? null), "text", [])) {
            ...
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", [], "any", false, true), "twig", [], "any", false, true), "filters", [], "any", false, true), "tu", [], "array", true, true)) {
                // line 53
                echo "                    ";
                echo (($this->getAttribute(($context["field"] ?? null), "markdown", [])) ? ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->markdownFunction($context, $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter($this->getAttribute(($context["field"] ?? null), "text", [])))) : ((("<p>" . $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter($this->getAttribute(($context["field"] ?? null), "text", []))) . "</p>")));
                echo "
                ";
            } else {
                // line 55
                echo "                    ";
                echo (($this->getAttribute(($context["field"] ?? null), "markdown", [])) ? ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->markdownFunction($context, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->env, $this->getAttribute(($context["field"] ?? null), "text", [])))) : ((("<p>" . $this->getAttribute(($context["field"] ?? null), "t", [])) . "</p>")));
                echo "
                ";
            }
            // line 57
...
{% endblock %}
", "forms/fields/fieldset/fieldset.html.twig", "/Users/antoinequarroz/Sites/suffrageFeminin/user/plugins/admin/themes/grav/templates/forms/fields/fieldset/fieldset.html.twig");
    }
}
