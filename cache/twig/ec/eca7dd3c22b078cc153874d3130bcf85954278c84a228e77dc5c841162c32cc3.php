...
class __TwigTemplate_e036a7d204f550a811cddf1023a647dd2ea6bb73d6137da91e92c457918a0879 extends \Twig\Template
{
...
<div class=\"remodal\" data-remodal-id=\"wizard\" data-remodal-options=\"hashTracking: false, closeOnOutsideClick: false\">
    ...
    <div class=\"step-1\">
        ...
        <div class=\"panel hidden disabled\">
                    ...
                    <label for=\"gs-user-field\">
                        <span class=\"block\">
                            ...
                            <label for=\"gs-no-user\" class=\"no_user\">
                                <input id=\"gs-no-user\" type=\"checkbox\" name=\"gitsync[no_user]\" ";
            // line 59
            echo (($this->getAttribute(($context["settings"] ?? null), "no_user", [])) ? ("checked") : (""));
            echo "/>
                                No User
                            </label>
                        </span>
                        <input
                            ...
                            ";
            // line 67
            if ($this->getAttribute(($context["settings"] ?? null), "no_user", [])) {
                // line 68
            ...
            // line 70
            echo "                            placeholder=\"";
            echo (($this->getAttribute(($context["settings"] ?? null), "no_user", [])) ? ("<username not required>") : ("Username, not email"));
            echo "\"
                            value=\"";
            // line 71
...
";
    ...
    {
        return array (  650 => 451,  632 => 435,  613 => 418,  601 => 414,  596 => 413,  568 => 387,  554 => 383,  550 => 382,  547 => 381,  542 => 380,  531 => 379,  528 => 378,  519 => 372,  516 => 371,  514 => 370,  506 => 365,  497 => 359,  489 => 354,  481 => 349,  473 => 344,  447 => 321,  441 => 320,  418 => 300,  412 => 299,  391 => 283,  369 => 264,  362 => 262,  343 => 246,  338 => 244,  332 => 241,  320 => 232,  310 => 225,  288 => 206,  150 => 71,  145 => 70,  141 => 68,  139 => 67,  128 => 59,  116 => 50,  112 => 49,  105 => 45,  101 => 44,  94 => 40,  90 => 39,  83 => 35,  79 => 34,  68 => 25,  65 => 24,  62 => 23,  59 => 22,  57 => 21,  42 => 8,  40 => 7,  34 => 3,  32 => 2,  30 => 1,);
    }
...
", "partials/modal-wizard.html.twig", "/Users/antoinequarroz/Sites/suffrageFeminin/user/plugins/git-sync/templates/partials/modal-wizard.html.twig");
    }
}
